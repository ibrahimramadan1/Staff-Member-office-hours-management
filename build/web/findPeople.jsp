<%-- 
    Document   : findPeople
    Created on : Jan 13, 2021, 1:12:14 AM
    Author     : Hema
--%>
...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><span class="pe-7s-search"></span> Find contact of DRs/TAs/students by username</label>
    ...
    <script src="js/manageFindPeople.js"></script>
