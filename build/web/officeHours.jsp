<%-- 
    ...
    Created on : Jan 15, 2021, 2:55:31 PM
    Author     : Hema
--%>
                    ...
                    <div class="container-fluid">
                            ...
                            <form id="dates">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="fromDate" id="fromDate" type="date" class="form-control" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>to date</label>
                                        <input name="toDate" id="toDate" type="date" class="form-control" value="">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">your office hours</h4>
                                    </div>
                                    <br>
                                    <div id="urOH">
